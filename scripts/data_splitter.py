...
if __name__ == "__main__":
    ...
    images_folder = os.path.join(base_dir, '../data/annotations/images')  # Carpeta de imágenes originales
    labels_folder = os.path.join(base_dir, '../data/annotations/labels')  # Carpeta de etiquetas originales
